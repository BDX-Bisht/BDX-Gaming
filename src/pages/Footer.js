        ...
        <footer className="text-gray-400 bg-gray-900 body-font">
            ...
            <div className="bg-gray-800 bg-opacity-75">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-400 text-sm text-center sm:text-left">© 2023 BDX —
                        <a href="https://github.com/BDX-Bisht" rel="noopener noreferrer" className="text-gray-500 ml-1" target="_blank">@Dipanshu_Bisht</a>
                    </p>
